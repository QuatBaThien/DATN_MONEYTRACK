...
class WalletDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        wallet = walletViewModel.getWalletByWalletID(walletID!!) ?: Wallet("", false, "", "", "")
    ...
    private fun populateWalletDetails() {
        ...
        binding.etWalletBalance.setText(wallet.balance)
    }

    private fun saveChanges() {
        wallet.name = binding.etWalletName.text.toString()
        wallet.balance = binding.etWalletBalance.text.toString()
